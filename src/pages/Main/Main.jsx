          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 인천계양 유탑유블레스에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="인천계양 유탑유블레스 모바일 조감도 이미지"
            />
          </div>
